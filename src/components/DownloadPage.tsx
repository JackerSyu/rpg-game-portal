  ...
  return (
    <section className="section">
      <div className="container">
        {/* 標題與副標題 */}
        <h1 className="title has-text-centered">遊戲下載</h1>
          ...
          <table className="table is-fullwidth is-striped mt-3">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a
                    href="/downloads/patch-1.0.1.zip"
              ...
              <tr>
                ...
                <td>
                  <a
                    href="/downloads/patch-1.1.0.zip"
                    className="button is-small is-primary"
                  >
                    下載
                  </a>
              ...
              <tr>
                ...
                <td>
                  <a
                    href="/downloads/patch-1.2.0.zip"
                    className="button is-small is-primary"
                  >
                    下載
                  </a>
        ...
        <div className="box mt-5" id="faq">
          ...
          {/* 無法開啟時該怎麼辦 */}
          <div className="mt-4">
            <h3 className="subtitle is-5 is-italic">Q: 無法開啟時該怎麼辦？</h3>
            <h3 className="subtitle is-5">
